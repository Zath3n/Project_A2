...
With paths leading form the top left to bottom right
Each levels maze will be harder then the last.
with more paths and dead ends then the one before 


Are their items?
Their are no items. Just a NPC that wonders around the maze
